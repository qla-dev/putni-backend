...
Laravel 12 JSON API for the Expo app. It provides Google and Apple social
authentication with Sanctum bearer tokens and four authenticated travel-order
CRUD operations: list, create, update, and delete.
