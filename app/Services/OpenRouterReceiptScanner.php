...
class OpenRouterReceiptScanner
{
    public function scan(array $images, string $documentType = 'receipt'): array
    {
        ...
        $userPrompt = $isAirTicket
            ...
            : 'Očitaj trgovca, datum računa ili putovanja u formatu YYYY-MM-DD, broj računa ili karte, kategoriju, valutu kao ISO 4217 kod, osnovicu, PDV, ukupan iznos u izvornoj valuti, ukupan iznos preračunat u EUR, način plaćanja i svaki pojedinačni artikal ili uslugu. Ako je karta, očitaj i polazak, državu polaska, odredište i državu odredišta.';
